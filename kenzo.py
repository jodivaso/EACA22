...
def Sphere(n):
    ...
    command = "__sphere__("+str(n)+")"
    return KenzoSimplicialSet(kenzosphere, command)
...
def MooreSpace(m, n):
    ...
    EXAMPLES::
        ...
        [Z, 0, 0, 0, C2, 0, 0, 0]
    """
    command = "__moore__("+str(m)+","+str(n)+")"
    kenzomoore = __moore__(m, n)
    return KenzoSimplicialSet(kenzomoore, command)
...
def EilenbergMacLaneSpace(G, n):
    ...
    if G == ZZ:
        ...
        command = "__k_z__("+str(n)+")"
        return KenzoSimplicialGroup(kenzospace, command)
    elif G == AdditiveAbelianGroup([2]):
        kenzospace = __k_z2__(n)
        command = "__k_z2__("+str(n)+")"
        return KenzoSimplicialGroup(kenzospace, command)
    elif G in CommutativeAdditiveGroups() and G.is_cyclic():
        command = "__k_zp__("+str(G.cardinality())+","+str(n)+")"        
...
class KenzoObject(SageObject):
    ...
    def __init__(self, kenzo_object, command):
        r"""
...
class KenzoChainComplex(KenzoObject):
    ...
    def tensor_product(self, other):
        ...
        EXAMPLES::
            ...
            [Z, 0, Z, Z, 0, Z, 0, 0]
        """
        command= "__tnsr_prdc__("+self.orgn+","+ other.orgn +")"
        return KenzoChainComplex(__tnsr_prdc__(self._kenzo, other._kenzo), command)
...
class KenzoSimplicialSet(KenzoChainComplex):
    ...
    def loop_space(self, n=1):
        ...
        EXAMPLES::
            ...
            [Z, Z, Z, Z, Z, Z, Z, Z]
        """
        command= "__loop_space__("+self.orgn+","+str(n)+")"
        return KenzoSimplicialGroup(__loop_space__(self._kenzo, n), command)
    ...
    def cartesian_product(self, other):
        ...
        command= "__crts_prdc__("+self.orgn+","+other.orgn+")"
        return KenzoSimplicialSet(prod_kenzo, command)
    ...
    def suspension(self):
        ...
        EXAMPLES::
            ...
            [Z, 0, 0, 0, Z, 0]
        """
        command= "__suspension__("+self.orgn+")"
        return KenzoSimplicialSet(__suspension__(self._kenzo), command)
    ...
    def wedge(self, other):
        ...
        EXAMPLES::
            ...
            [Z, 0, Z, Z, 0, 0]
        """
        command= "__wedge__("+self.orgn+","+other.orgn+")"
        wedge_kenzo = __wedge__(self._kenzo, other._kenzo)
        return KenzoSimplicialSet(wedge_kenzo, command)
    ...
    def join(self, other):
        ...
        EXAMPLES::
            ...
            [Z, 0, 0, 0, 0, 0]
        """
        command= "__join__("+self.orgn+","+other.orgn+")"
        join_kenzo = __join__(self._kenzo, other._kenzo)
        return KenzoSimplicialSet(join_kenzo, command)
    ...
    def smash_product(self, other):
        ...
        EXAMPLES::
            ...
            [Z, 0, 0, 0, 0, Z]
        """
        command= "__smash_product__("+self.orgn+","+other.orgn+")"
        smash_kenzo = __smash_product__(self._kenzo, other._kenzo)
        return KenzoSimplicialSet(smash_kenzo, command)
...
class KenzoSimplicialGroup(KenzoSimplicialSet):
    ...
    def classifying_space(self):
        ...
        EXAMPLES::
            ...
            [Z, 0, 0, 0, C2, 0, 0, 0]
        """
        command= "__classifying_space__("+self.orgn+")"
        return KenzoSimplicialGroup(__classifying_space__(self._kenzo), command)
